#ifndef EXCAFE_NUMERIC_SYMPY_EXPRESSION_CONVERTER_HPP
#define EXCAFE_NUMERIC_SYMPY_EXPRESSION_CONVERTER_HPP
...
public:
  ...
  {
    stack.push(boost::python::make_tuple(FLOAT, excafe::numeric_cast<double>(s)));
  }

  virtual void visitConstant(const integer_t& s)
  {
    stack.push(boost::python::make_tuple(INTEGER, excafe::numeric_cast<long>(s)));
  }
