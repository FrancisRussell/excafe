#ifndef EXCAFE_NUMERIC_POLYNOMIAL_HPP
#define EXCAFE_NUMERIC_POLYNOMIAL_HPP
...
public:
  ...
  {
    addConstant(excafe::numeric_cast<value_type>(constant));
    cleanZeros();
  }
...
{
  template<typename V>
  void swap(excafe::Polynomial<V>& a, excafe::Polynomial<V>& b)
  {
    a.swap(b);
  }
}
